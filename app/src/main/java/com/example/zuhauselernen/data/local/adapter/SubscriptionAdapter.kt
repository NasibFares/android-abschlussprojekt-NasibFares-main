...
class SubscriptionAdapter(
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): SubscriptionAdapter.ItemViewHolder {
    ...
    override fun onBindViewHolder(holder: SubscriptionAdapter.ItemViewHolder, position: Int) {
         ...
         */
        //holder.binding.rgSubscription.setOnCheckedChangeListener(null)
